...
class SocketClient():
    ...
    def send_recv(self, input_data):
        ...
        # sockインスタンスを生成
        try:
#            sock=socket.socket(socket.AF_INET, socket.SOCK_STREAM) #TCI connect kakunin ari connect
            sock=socket.socket(socket.AF_INET, socket.SOCK_DGRAM) #UDP connect kakunin nashi connect
